...
async function onSaveAndContinue() {
  ...
  await formRef.value.validate(async (valid) => {
    ...
    try {
      ...
      Object.assign(form, {
        category: form.category, // 保留分类便于连续录入同类事项
        related_system: '', requester: '', department_id: null, contact_phone: '',
        location: '', problem_description: '', handling_process: '', fault_cause: '',
        result: '', status: 'pending', handler: '', started_at: '', finished_at: '', remark: '',
      })
